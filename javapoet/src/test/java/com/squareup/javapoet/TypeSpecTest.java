...
public final class TypeSpecTest {
    ...
    public void typeVariableWithBounds() {
        AnnotationSpec a =
                AnnotationSpec.builder(ClassName.get("com.squareup.tacos", "A")).build();
        TypeVariableName p = TypeVariableName.get("P", Number.class);
        TypeVariableName q =
        ...
        try {
            TypeSpec.classBuilder("Tacos")
                    .addMethod(MethodSpec.methodBuilder("test")
                            ...
                            .returns(int.class)
                            .addCode(
                                    CodeBlock.builder().addStatement("return 0").build())
                            .build())
                    .build();
            fail();
        } catch (IllegalStateException expected) {
    ...
    public void tryCatch() {
        TypeSpec taco = TypeSpec.classBuilder("Taco")
                .addMethod(MethodSpec.methodBuilder("addTopping")
                        ...
                        .nextControlFlow("catch ($T e)", ClassName.get("com.squareup.tacos", "IllegalToppingException"))
                        .endControlFlow()
                        .build())
                .build();
        assertThat(toString(taco))
    ...
    public void initializersToBuilder() {
        ...
        assertThat(taco.alwaysQualifiedNames).containsExactlyElementsIn(recreatedTaco.alwaysQualifiedNames);
    ...
    public void lineWrapping() {
        ...
        assertThat(toString(taco))
                .isEqualTo("package com.squareup.tacos;\n"
                        ...
                        + "\n"
                        + "class Taco {\n"
                        + "  void call(String s0, String s1, String s2, String s3, String s4, String s5, String"
                        + " s6, String s7,\n"
                        + "      String s8, String s9, String s10, String s11, String s12, String s13, String"
                        + " s14, String s15,\n"
                        + "      String s16, String s17, String s18, String s19, String s20, String s21, String"
                        + " s22,\n"
                        + "      String s23, String s24, String s25, String s26, String s27, String s28, String"
                        + " s29,\n"
