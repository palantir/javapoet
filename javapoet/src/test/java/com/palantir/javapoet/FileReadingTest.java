...
public class FileReadingTest {
    ...
    public void javaFileObjectUri() {
        ...
        assertThat(JavaFile.builder("com.example", type)
                        .build()
                        .toJavaFileObject()
                        .toUri())
    ...
    public void javaFileObjectInputStreamIsUtf8() throws IOException {
        JavaFile javaFile = JavaFile.builder(
                        "foo", TypeSpec.classBuilder("Test").build())
    ...
    public void compileJavaFile() throws Exception {
        ...
        assertThat(Iterables.filter(diagnosticCollector.getDiagnostics(), FileReadingTest::isNotNote))
                .isEmpty();
    ...
    private static <S> boolean isNotNote(Diagnostic<S> diagnostic) {
        return diagnostic.getKind() != Diagnostic.Kind.NOTE;
    }
}
